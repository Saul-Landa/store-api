...
public class JwtService {
    ...
    public static final String SECRET = "5367566B59703373367639792F423F4528482B4D6251655468576D5A78465123";

    public JwtService(ISalesPersonService salesPersonService) {
    ...
    public String generateToken(String userName) {
        ...
        SalesPerson salesPerson = salesPersonService.findByUsername(userName);
        claims.put("id", salesPerson.getId());
